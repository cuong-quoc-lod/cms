  ...
  return (
    <div className="auth-container">
      <div className="auth-card animate-fade-in">
        <h2 style={{ textAlign: 'center', marginBottom: '2rem', fontSize: '1.875rem' }}>Đăng ký</h2>
        ...
        <p style={{ textAlign: 'center', color: 'var(--text-muted)', fontSize: '0.875rem' }}>
          Đã có tài khoản? <Link to="/login" style={{ color: 'var(--primary)', textDecoration: 'none', fontWeight: '500' }}>Đăng nhập</Link>
        </p>
      </div>
    </div>
  );
